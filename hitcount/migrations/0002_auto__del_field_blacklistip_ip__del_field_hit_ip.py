...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'BlacklistIP.ip'
        raise RuntimeError("Cannot reverse this migration. 'BlacklistIP.ip' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Hit.ip'
        raise RuntimeError("Cannot reverse this migration. 'Hit.ip' and its values cannot be restored.")
